...
def run_trials(input_path: Path,
    ...
    for i in range(num_trials):
        ...
        model = multi_rgb_depth_model(num_classes,
        ...
        run_log = f'rgb_depth_{trial_num:03}.csv'
        run_model_summary = f'rgb_depth_{trial_num:03}_model_summary.txt'
        model_checkpoint = f'rgb_depth_{trial_num:03}.best.hdf5'
